...
- Name: notifications.spec.ts >> NotificationsScreen >> notification actions use updated selectors when rows are present
- Location: e2e/notifications.spec.ts:72:7
